...
(function (modules) {
	...
	function (module, exports, __webpack_require__) {
		...
		}.call(exports, __webpack_require__(106)));
	},
	function (module, exports, __webpack_require__) {
	...
	function (module, exports, __webpack_require__) {
		...
		window.CernerSmartEmbeddableLib.calcFrameHeight =
			_cernerSmartEmbeddableLib2.default.calcFrameHeight;
		window.CernerSmartEmbeddableLib.setFrameHeight =
			_cernerSmartEmbeddableLib2.default.setFrameHeight;
	},
	function (module, exports, __webpack_require__) {
		'use strict';
		Object.defineProperty(exports, '__esModule', { value: true });
	...
	function (module, exports, __webpack_require__) {
		'use strict';
		Object.defineProperty(exports, '__esModule', { value: true });
		var _application = __webpack_require__(48);
			...
			init: function init(config) {
				...
				if (
					...
					_logger2.default.warn(
						'Security warning: Hidden attribute not detected on document and has been added.'
					);
				}
	...
	function (module, exports, __webpack_require__) {
		...
		var _jsonrpcDispatch = __webpack_require__(49);
		...
		var Application = (function (_EventEmitter) {
			...
			function Application() {
				...
				return _possibleConstructorReturn(
					this,
					(Application.__proto__ || Object.getPrototypeOf(Application)).apply(this, arguments)
				);
			}
				...
				},
				{
					...
					value: function requestResize() {
						if (this.resizeConfig.customCal) {
							...
							var height = (0, _dimension.calculateHeight)(
								this.resizeConfig.heightCalculationMethod
							);
							if (this.targetSelectors || this.resizeConfig.targetSelectors) {
								var targetSelectors = [this.targetSelectors, this.resizeConfig.targetSelectors]
									.filter(function (val) {
										return val;
									})
									.join(', ');
								var heights = [].slice
									.call(document.querySelectorAll(targetSelectors))
									.map(_dimension.getOffsetHeightToBody);
				...
				},
				{
					...
					value: function verifyChallenge(secretAttempt) {
						...
						if (
							...
							(0, _string.fixedTimeCompare)(this.secret, secretAttempt)
						) {
							authorize();
		...
		$export(
			$export.S +
				$export.F *
					!(
						USE_NATIVE &&
						__webpack_require__(84)(function (iter) {
	...
	function (module, exports, __webpack_require__) {
		...
		function calculateHeight() {
			var calMethod =
				arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'bodyOffset';
